...
def find_notebooks(driver):
  print("Searching Notebooks", end="  pages  => ")
  ...
  for _, row in df.iterrows():
    ...
    for notebook_element in notebooks_elements:
      notebook = {
        ...
        'name': notebook_element.find_element(By.XPATH,'.//h3/a').text,
        'processor name': row['name'],
        'score': int(row['score']),
        ...
        'url': notebook_element.find_element(By.XPATH,'.//h3/a').get_attribute('href'),
      }
